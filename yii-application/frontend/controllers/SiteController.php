...
class SiteController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'signup', 'user', 'admin','organizador'],
                'rules' => [
                    [
                        'actions' => ['signup'],
                        'allow' => true,
                    ...
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            //Llamada al método que comprueba si es un usuario simple
                            return User::isUserOrganizador(Yii::$app->user->identity->username);
                        },
                    ],
                ],
            ],
    ...
    public function actionLogin()
    {
        ...
        } elseif ($model->load(Yii::$app->request->post()) && $model->loginUsuarioResgistrado()) {
            return $this->redirect(["site/user"]);
        } elseif ($model->load(Yii::$app->request->post()) && $model->loginOrganizador()) {
            return $this->redirect(["site/organizador"]);
        } else {
    ...
    {
        return $this->render('organizador');
    }
    /**
    ...
    public function actionContact()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->sendEmail(Yii::$app->params['adminEmail'])) {
                Yii::$app->session->setFlash('Exito', 'Gracias por contactarnos. Nosotros responderemos a la mayor brevedad posible.');
            } else {
    ...
    public function actionVerifyEmail($token)
    {
        ...
        if ($user = $model->verifyEmail()) {
            if (Yii::$app->user->login($user)) {
                Yii::$app->session->setFlash('Exito', '¡Tu correo ha sido confirmado!');
                return $this->goHome();
            }
        }
